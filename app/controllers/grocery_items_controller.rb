class GroceryItemsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to grocery_items_path, status: :see_other, notice: "Grocery item was successfully destroyed." }
  ...
  private
    ...
    def set_grocery_item
      @grocery_item = GroceryItem.find(params.expect(:id))
    end
